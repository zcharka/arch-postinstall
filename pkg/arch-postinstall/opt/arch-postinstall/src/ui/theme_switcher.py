...
class ThemeAppWindow(Adw.ApplicationWindow):
    def __init__(self, app):
        super().__init__(application=app, title="Presets") # ZMIANA NAZWY
    ...
    def detect_de(self):
        ...
        # FALLBACK DLA TESTÓW (jeśli nic nie wykryje, załóż KDE)
        return "kde"
    ...
    def init_pages(self):
        # 1. STRONA GŁÓWNA - Używamy Boxa zamiast PreferencesPage (NAPRAWA PUSTEGO GUI)
